    ...
    return (
        <div className="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
            ...
            <Form method="post" className="space-y-6">
                ...
                <div>
                    <label className="block mb-2 text-sm font-medium text-gray-90">Examination Code</label>
                ...
                <button type="submit" disabled={isSubmitting} className="w-full text-white bg-wizeblue-100 hover:bg-wizeblue-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center">{isSubmitting ? 'Authenticating...': 'Log In'}</button>
            </Form>
        </div>
    );
}