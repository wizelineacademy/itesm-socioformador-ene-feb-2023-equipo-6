        ...
        <div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
            <Form class="space-y-6" action="#">
                ...
                <div>
                    ...
                    <input type="text" name="code" class="bg-gray-50 border-4 border-b-wizeblue-100 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="XXXX-XXXX"/>
                </div>
